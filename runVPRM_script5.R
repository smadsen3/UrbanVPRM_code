...
#if on computer:
#dir_clima = paste0('C:/Users/kitty/Documents/Research/SIF/UrbanVPRM/UrbanVPRM/dataverse_files/GTA_V061_500m_2018/2018') # climate data in /urbanVPRM_30m/driver_data/rap_goes/
#if on external hard-drive
dir_clima = paste0('E:/Research/UrbanVPRM/dataverse_files/GTA_V061_500m_2018/2018')
...
LC = raster('C:/Users/kitty/Documents/Research/SIF/UrbanVPRM/UrbanVPRM/dataverse_files/GTA_500m_V061_no_adjustments_2018/LandCover/MODIS_LC_GTA_500m_V061_no_adjustments_2018.tif') # Land cover data in /urbanVPRM_30m/driver_data/lc_isa/
...
ISA_dat = raster('C:/Users/kitty/Documents/Research/SIF/UrbanVPRM/UrbanVPRM/dataverse_files/GTA_500m_V061_no_adjustments_2018/ISA/ISA_GTA_500m_2018.tif') # Impervious data in /urbanVPRM_30m/driver_data/lc_isa/
ISA.dt = tifdt_fun(ISA_dat,"ISA")

C4 = raster('C:/Users/kitty/Documents/Research/SIF/UrbanVPRM/UrbanVPRM/dataverse_files/GTA_500m_V061_no_adjustments_2018/LandCover/C4_frac_GTA_500m_2018.tif') # C4 fraction
...
wtr_dat = raster('C:/Users/kitty/Documents/Research/SIF/UrbanVPRM/UrbanVPRM/Impermeable_Surface/SOLRIS_aggregated_water_cover_GTA.tif') # aggregated to MODIS resolution
...
LS_VI.dt = fread('C:/Users/kitty/Documents/Research/SIF/UrbanVPRM/UrbanVPRM/dataverse_files/GTA_500m_V061_no_adjustments_2018/adjusted_evi_lswi_interpolated_modis.csv', data.table=FALSE) #EVI/LSWI data in /urbanVPRM_30m/driver_data/evi_lswi/
...
for(j in 1:length(blocks)) { 
  ...
  clima.dt = readRDS(paste0(dir_clima,"/rap_goes_GTA_V061_500m_2018_hourly_fixed.rds"))
  #}
  ...
  if(length(blocks)>1){
    write.table(output.dt, paste0(city,"/vprm_mixed_GTA_500m_V061_2018_no_adjustment_",sprintf("%08i",as.numeric(block)),".csv"),
                row.names = F, sep = ',')
    #saveRDS(output.dt, paste0(dir_out,"/fluxes_",city,"_",yr,"_",veg_type,"_block_",
    #                          sprintf("%08i",as.numeric(block)),".rds"))
  } else {
    write.table(output.dt, "GTA_500m_V061_no_adjustments_2018/vprm_mixed_ISA_GTA_500m_V061_2018_no_adjustments.csv",row.names = F,
                sep = ',')
  }
